...
urlpatterns = patterns('servicos.views',
	...
	url(r'^editar/(?P<id>\d+)/$', 'servico_editar', name='servico_editar'),
	url(r'^alterar_status/(?P<id>\d+)/$', 'servico_alterar_status', name='servico_alterar_status'),
	...
	url(r'^editar/tipo/(?P<id>\d+)/$', 'tipo_servico_editar', name='tipo_servico_editar'),
	url(r'^alterar_status/tipo/(?P<id>\d+)/$', 'tipo_servico_alterar_status', name='tipo_servico_alterar_status'),
)