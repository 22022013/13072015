...
urlpatterns = patterns('funcionarios.views',
	...
	url(r'^editar/(?P<id>\d+)/$', 'funcionario_editar', name='funcionario_editar'),
	url(r'^alterar_status/(?P<id>\d+)/$', 'funcionario_alterar_status', name='funcionario_alterar_status'),
	...
	url(r'^funcao/editar/(?P<id>\d+)/$', 'funcao_editar', name='funcao_editar'),
	url(r'^funcao/alterar_status/(?P<id>\d+)/$', 'funcao_alterar_status', name='funcao_alterar_status'),
)